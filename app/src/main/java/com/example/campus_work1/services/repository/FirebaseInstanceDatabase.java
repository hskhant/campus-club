package com.example.campus_work1.services.repository;
...
public class FirebaseInstanceDatabase {
    ...
    public MutableLiveData<Boolean> addChatsInDatabase(final String receiverId, final String senderId, String message, final String timestamp) {
        ...
        final DatabaseReference chatRef = instance.getReference("ChatList")
                .child(senderId)
                .child(receiverId);
        ...
        final DatabaseReference chatRef2 = instance.getReference("ChatList")
                .child(receiverId)
                .child(senderId);
