package com.example.campus_work1.view.ui;
...
import com.example.campus_work1.services.model.Chats;
import com.example.campus_work1.services.model.Users;
import com.example.campus_work1.services.notifications.Client;
import com.example.campus_work1.services.notifications.Data;
import com.example.campus_work1.services.notifications.MyResponse;
import com.example.campus_work1.services.notifications.Sender;
import com.example.campus_work1.services.notifications.Token;
import com.example.campus_work1.view.adapters.MessageAdapter;
import com.example.campus_work1.view.fragments.APIService;
import com.example.campus_work1.view.fragments.BottomSheetProfileDetailUser;
import com.example.campus_work1.viewModel.DatabaseViewModel;
import com.example.campus_work1.viewModel.LogInViewModel;
...
public class MessageActivity extends AppCompatActivity {
    ...
    private void fetchChatFromDatabase(final String myId, final String senderId) {
        databaseViewModel.fetchChatUser();
        databaseViewModel.fetchedChat.observe(this, new Observer<DataSnapshot>() {
            @Override
            public void onChanged(DataSnapshot dataSnapshot) {
    ...
    private void sendNotification(final String userId_receiver, final String username, final String msg) {
