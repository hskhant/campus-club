package com.example.campus_work1.view.adapters;
...
import com.example.campus_work1.view.ui.MessageActivity;
...
public class UserFragmentAdapter extends RecyclerView.Adapter<UserFragmentAdapter.UserFragmentHolder> {
    ...
    public void onBindViewHolder(@NonNull UserFragmentHolder holder, int position) {
        ...
        final String imageUrl = users.getImageUrl();
        final String userName = users.getUsername();
        final String bio = users.getBio();
